...
const WeeklyForecastItem = ({ value, type }) => {
  ...
  if (type === 'temperature')
    iconContent = <ThermostatIcon sx={{ fontSize: { xs: '15px', sm: '16px', md: '18px' } }} />;
  else if (type === 'wind')
    iconContent = <AirIcon sx={{ fontSize: { xs: '15px', sm: '16px', md: '18px' } }} />;
  else if (type === 'clouds')
    iconContent = <FilterDramaIcon sx={{ fontSize: { xs: '15px', sm: '16px', md: '18px' } }} />;
  else if (type === 'humidity')
    iconContent = (
      <SvgIcon
        component={HumidityIcon}
